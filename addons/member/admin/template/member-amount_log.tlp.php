                ...
                <div class="config-items">
					<div class="admin-nav">
                        ...
                        <div class="nav">
                            ...
                            <a href="{__PW_PATH__}{__ADMIN_FILE__}?mod={$mod}&file={$file}&action=credits_log">积分日志</a>
							<a href="{__PW_PATH__}{__ADMIN_FILE__}?mod={$mod}&file={$file}&action={$action}" class="hover">余额日志</a>
                        </div>
                        ...
                        <table class="result-tab" width="100%">
						  ...
						  {loop $data $r}
							...
							<tr>
								...
								<td>{date('Y-m-d H:i:s',$r['amounttime'])}</td>

								<td>{php echo $r['inc']>0?'<font style="color:#009933;">增加</font>':'<font style="color:#FF3300;">减少</font>';} <font style="color:#009933; font-weight:bold">{$r['amount']}</font> 元</td>
