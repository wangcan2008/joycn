            ...
            <form action="" method="post" name="mysubmitform" id="mysubmitform" enctype="multipart/form-data">
                ...
                <div class="config-items">     
					<div class="admin-nav">
                        <h2>自动回复</h2>
                        <div class="nav">
                            <a href="{__PW_PATH__}{__ADMIN_FILE__}?mod=wechat&file=core&action=subscribereply" class="hover">被关注自动回复</a>
                    ...
                    <div class="si-editor">
                        ...
                        <div class="si-content" id="material-dialog-media"{if $PW['wechat_subscribe_msg_type']!='media'} style="display:none"{/if}>
                        ...
                        <div class="si-content" id="material-dialog-text"{if $PW['wechat_subscribe_msg_type']!='text'} style="display:none"{/if}>
                        	<textarea cols="55" rows="6" id="wechat_subscribe_msg_text" style="width:850px; height:250px; border:0px; font-family:'Microsoft YaHei';overflow:auto;resize:none; background:none" name="config[wechat_subscribe_msg_text]">{$PW['wechat_subscribe_msg_text']}</textarea>
                            <br>
     ...
     <div id="image-material-dialog" class="reveal-modal" style="width:95%;  left:320px">
        ...
        <div class="material-list" style=" height:520px; overflow:auto">
            <ul>
                ...
                $('#wechat_subscribe_msg_value').val('<?php echo $r['media_id'];?>');$('.close-reveal-modal').click();"><img src="{format_url($r['local_url'])}" style="width:155px; height:152px" /></li>
				{/loop}
            </ul>
        </div>
        <a class="close-reveal-modal">&#215;</a>
