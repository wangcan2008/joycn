    ...
    <div class="ifame-main-wrap">
        ...
        <div class="material-list">
			...
			<div class="btn-post">
				...
				<a href="javascript:void(0);" onClick="if(!confirm('由于音频文件较大，本地上传很可能失败！强烈建议您去微信公众号官方平台上传语音素材！')){return false;}else{$('#voice_material').click();}" class="a-btn-post"><i class="icon-font">&#xe026;</i> 上传语音素材</a>
