            ...
            <form action="" method="post" name="mysubmitform" id="mysubmitform" enctype="multipart/form-data">
                ...
                <div class="config-items">
                    <div class="admin-nav">
                        <h2>公众号配置</h2>
                        <div class="nav">
                            <a href="{__PW_PATH__}{__ADMIN_FILE__}?mod=wechat&file=config&action=config" class="hover">公众号配置</a>
                            <a href="{__PW_PATH__}{__ADMIN_FILE__}?mod=wechat&file=config&action=interface">公众号接入</a>
                        </div>
                    </div>
