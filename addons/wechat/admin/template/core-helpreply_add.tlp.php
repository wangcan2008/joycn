            ...
            <form action="" method="post" name="mysubmitform" id="mysubmitform" enctype="multipart/form-data">
                ...
                <div class="config-items">     
                    ...
                    <div class="si-editor">
						...
						<div class="si-content" id="material-dialog-media"{if $PW['wechat_help_msg_type']!='media'} style="display:none"{/if}>
                        ...
                        <div class="si-content" id="material-dialog-text"{if $PW['wechat_help_msg_type']!='text'} style="display:none"{/if}>
							...
							<div class="emojidiv" id="emojidiv">
								<ul>
									...
									<li onClick="$('#wechat_help_msg_text').insertContent('[{$r['emoji']}]'); "><img src="{__PW_PATH__}addons/wechat/admin/template/images/emoji/{$r['emoji']}.png"></li>
									{/loop}
								</ul>
							</div>
							</span>
                        ...
                        <div class="si-content" id="material-dialog-image"{if $PW['wechat_help_msg_type']!='image'} style="display:none"{/if}>
                       		<div class="si-add-left">
                        ...
                        <div class="si-content" id="material-dialog-voice"{if $PW['wechat_help_msg_type']!='voice'} style="display:none"{/if}>
                       		<div class="si-add-left">
                        ...
                        <div class="si-content" id="material-dialog-video"{if $PW['wechat_help_msg_type']!='video'} style="display:none"{/if}>
                       		<div class="si-add-left">
     ...
     <div id="image-material-dialog" class="reveal-modal" style="width:95%;  left:320px">
        ...
        <div class="material-list" style=" height:520px; overflow:auto">
            <ul>
                ...
                $('#media_id').val('<?php echo $r['media_id'];?>');$('.close-reveal-modal').click();"><img src="{format_url($r['local_url'])}" style="width:155px; height:152px" /></li>
				{/loop}
            </ul>
        </div>
        <a class="close-reveal-modal">&#215;</a>
