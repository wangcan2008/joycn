                ...
                <div class="config-items">     
					<div class="admin-nav">
                        ...
                        <div class="nav">
                            ...
                            <a href="{__PW_PATH__}{__ADMIN_FILE__}?mod=wechat&file=core&action=autoreply" class="hover">消息自动回复</a>
                            <a href="{__PW_PATH__}{__ADMIN_FILE__}?mod=wechat&file=core&action=helpreply">关键词自动回复</a>
                        </div>
                    ...
                    <div class="si-editor">
                        ...
                        <div class="si-content" id="material-dialog-media"{if $PW['wechat_auto_msg_type']!='media'} style="display:none"{/if}>
                        ...
                        <div class="si-content" id="material-dialog-text"{if $PW['wechat_auto_msg_type']!='text'} style="display:none"{/if}>
                        	<textarea cols="55" rows="6" id="wechat_auto_msg_text" style="width:850px; height:250px; border:0px; font-family:'Microsoft YaHei';overflow:auto;resize:none; background:none" name="config[wechat_auto_msg_text]">{$PW['wechat_auto_msg_text']}</textarea>
                            <br>
							...
							<div class="emojidiv" id="emojidiv">
								<ul>
									...
									<li onClick="$('#wechat_auto_msg_text').insertContent('[{$r['emoji']}]'); "><img src="{__PW_PATH__}addons/wechat/admin/template/images/emoji/{$r['emoji']}.png"></li>
									{/loop}
								</ul>
							</div>
							</span>
                        ...
                        <div class="si-content" id="material-dialog-image"{if $PW['wechat_auto_msg_type']!='image'} style="display:none"{/if}>
                            ...
                            <div class=material-list>
                            	<ul>
                                    ...
                                    <img src="{format_url($imageinfo['local_url'])}" style="width:155px; height:152px" />
                                    </li>
                                </ul>
                           	</div>
                            <?php }else{?>
                        ...
                        <div class="si-content" id="material-dialog-voice"{if $PW['wechat_auto_msg_type']!='voice'} style="display:none"{/if}>
                        	<?php if($voiceinfo  && $PW['wechat_auto_msg_type']=='voice'){?>
                            <div class=material-list>
                            	<ul>
                                	<li data-reveal-id="voice-material-dialog"  data-animation="fade">
                                        <div class="date">{date('m月d日',$voiceinfo['created_at'])}</div>
                                        <div class="appmsg_thumb_wrp" style="height:80px;">
                                            <div class="left-div"></div>
                                            <div class="right-div">{$voiceinfo['name']}</div>
                                        </div>
                                    </li>
                                </ul>
                           	</div>
                        ...
                        <div class="si-content" id="material-dialog-video"{if $PW['wechat_auto_msg_type']!='video'} style="display:none"{/if}>
                        	<?php if($videoinfo  && $PW['wechat_auto_msg_type']=='video'){?>
                            <div class=material-list>
                            	<ul>
                                	<li data-reveal-id="video-material-dialog"  data-animation="fade">
                                        <div class="title">{date('Y年m月d日',$videoinfo['created_at'])}</div>
                    					<div class="appmsg_thumb_wrp" style="background-image:url('{__PW_PATH__}addons/wechat/admin/template/images/video.gif');background-size: inherit;"><span><a href="{$videoinfo['remote_url']}" target="_blank">{$videoinfo['name']}</a></span></div>
                                    </li>
                                </ul>
                           	</div>
                            <?php }else{?>
     ...
     <div id="image-material-dialog" class="reveal-modal" style="width:95%;  left:320px">
        ...
        <div class="material-list" style=" height:520px; overflow:auto">
            <ul>
                ...
                $('#wechat_auto_msg_value').val('<?php echo $r['media_id'];?>');$('.close-reveal-modal').click();"><img src="{format_url($r['local_url'])}" style="width:155px; height:152px" /></li>
				{/loop}
            </ul>
        </div>
        <a class="close-reveal-modal">&#215;</a>
