...
switch($action)
{
	...
	case 'material_edit':
		if(isset($dosbumit))
		{
			$op=WeChatManage::editMediaMaterial($Title,$Author,$Description,$PicUrl,$thumb_media_id,$content,$urls,$id);
	...
	case 'material_post':
		if(isset($dosbumit))
		{
			$op=WeChatManage::postMediaMaterial($Title,$Author,$Description,$PicUrl,$thumb_media_id,$content,$urls);
