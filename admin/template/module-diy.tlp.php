                        ...
                        <table width="100%" class="insert-tab">
                            <tbody>
                                ...
                                <tr class="formtr">
                                    ...
                                    <br>
                                    菜单URL：{__ADMIN_FILE__}?mod=<span class="nowmodaction"></span>&file=<span class="nowmodaction"></span>&action= <input type="text" class="common-text" name="menu[action][0]" value="config" size="16" />  
                                    &nbsp;&nbsp;
