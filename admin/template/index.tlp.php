    ...
    <div class="topbar-inner clearfix">
        <div class="topbar-logo-wrap clearfix">
            ...
            <ul class="navbar-list clearfix">
				<li><a href="{__PW_PATH__}{__ADMIN_FILE__}" style=" padding:0px"><img src="{__PW_PATH__}admin/template/images/logo.png" style="height:30px"></a></li>
				...
				{if  !$r['disabled'] && (isset($_privileges[$r['folder']]) || $_roleid==-1)}
        ...
        <div class="top-info-wrap">
            <ul class="top-info-list clearfix">
				...
				{else}
				<li><a href="{__PW_PATH__}{__ADMIN_FILE__}?mod=&file=admin&action=edit" target="iframe-wrap">{$_username}</a></li>
				{/if}
                <li><a href="{__PW_PATH__}{__ADMIN_FILE__}?mod=&file=admin&action=edit&userid={$_userid}" target="iframe-wrap">修改密码</a></li>
