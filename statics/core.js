...
function showToast(msg,url,duration)
{
	...
	m.innerHTML = msg;
	m.style.cssText="width:60%; min-width:150px; background:#000; opacity:0.5; min-height:40px; color:#fff; line-height:40px; text-align:center; border-radius:5px; position:fixed; top:40%; left:20%; z-index:999999;font-size:.85rem; font-weight:normal;";
